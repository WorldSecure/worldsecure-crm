...
function Customers() {
  ...
  const _paginatedAll = getSortedCustomers(filteredCustomers);
  ...
  const paginatedCustomer = _paginatedAll.slice((currentPage - 1) * _pageSize, currentPage * _pageSize);
